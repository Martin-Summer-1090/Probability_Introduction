...
- Write a function to simulate rolling a pair of dice. Each die produces a 
random number between 1 and 6. The function should return the sum of the two dice.
...
- Assume the dice are "loaded" such that numbers 1, 2, 3, 4, and 5 have probabilities of \( \frac{1}{8} \), while 6 has a probability of \( \frac{3}{8} \).
...
#### Exercise 4: The Probability of Specific Sums
...
3. Is betting on 7 a good strategy? Why, why not?


#### Exercise 6: Explore Alternative Scenarios
...
### Project 1: Detecting collisions in financial transactions
...
directly to practical challenges in computational finance.^[For more information and details you might want to check this source: https://www.hostmerchantservices.com/articles/what-are-transaction-ids/?utm_source=chatgpt.com]
...
Plot the collision probability as a function of nn for different values of $M$.
We did not cover Rs plotting functions in the lecture so far. We only showed some
