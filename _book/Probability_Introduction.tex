...
\hypertarget{examples-building-experiments-sample-spaces-and-events-using-r}{%
\section{Examples: Building experiments, sample spaces and events using R}\label{examples-building-experiments-sample-spaces-and-events-using-r}}
...
you omitt the trigger R just prints the body of the function. When you run a function,
all the code in the function body is executed and R returns the result of the last
line of code. If the last line of code does not return a vlaue neither will R.
...
RStuido has many useful features to help you work with scripts. You can for instance automatically
