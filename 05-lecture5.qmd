...
In this lecture we will introduce the most important probability distribution, 
the **normal distribution**. While we have discussed discrete random variables so far, where the 
