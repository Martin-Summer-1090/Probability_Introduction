...
The event we are interested in is that *at least two students have the same birthday*. It turns
out that it is easier to think about the complementary event, which is that 
*all students have different birthdays*. The way that $n$ students can have different birthdays
...
prod(365:(365-10+1))
```
The birthday problem plays an important role in cryptography, and its concept of hash-functions.
