...
\begin{document}
	\begin{tikzpicture}[
		...
		\draw (B1) -- (C1) node[midway, left=8pt] {$P(N) = 0.9$};
		\draw (B1) -- (C2) node[midway, right=8pt] {$P(D) = 0.1$};
		\draw (B2) -- (C3) node[midway, left=8pt] {$P(N|D) = 0.9$};
		\draw (B2) -- (C4) node[midway, right=8pt] {$P(D) = 0.1$};
		...
		\node[below=40pt] at (C1.south) {$R_{NN} = \begin{pmatrix} 1 \\ 1 \end{pmatrix}$};
		\node[below=40pt] at (C2.south) {$R_{ND} = \begin{pmatrix} 1 \\ 0 \end{pmatrix}$};
		\node[below=40pt] at (C3.south) {$R_{DN} = \begin{pmatrix} 1 \\ 0 \end{pmatrix}$};
		\node[below=40pt] at (C4.south) {$R_{DD} = \begin{pmatrix} 0 \\ 0 \end{pmatrix}$};
